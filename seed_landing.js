...
(async () => {
  ...
  if (beritaCount === 0) {
    await prisma.berita.createMany({
      data: [
        { judul: 'Kejuaraan Daerah Binaraga Kalimantan Barat 2026', ringkasan: 'Pengda FORBASI Kalimantan Barat akan menyelenggarakan Kejurda yang diikuti seluruh pengurus cabang se-Kalimantan Barat.', penulis: 'Admin', aktif: true },
        ...
        { judul: 'Pendaftaran Anggota Baru FORBASI', ringkasan: 'Pendaftaran anggota baru FORBASI Kalimantan Barat kini dapat dilakukan secara online melalui sistem informasi terpadu.', penulis: 'Admin', aktif: true },
      ]
    });
